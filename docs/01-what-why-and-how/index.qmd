...
This chapter explains what MoQ does, why it is useful, and how its parts fit together. We will begin with a short comparison with WebRTC, then use an online lecture to explain the model. After following a publication from publisher to player, we will examine the comparison in more detail and map the ideas to the rest of the book.
...
If you know WebRTC, start with this distinction: WebRTC gives the browser an integrated system for exchanging live audio and video. MOQT supplies the delivery part of a media system. A MoQ library combines it with codecs, media descriptions, and playback logic. The [detailed comparison below](#how-does-moq-compare-with-webrtc) explains what each approach supplies.
