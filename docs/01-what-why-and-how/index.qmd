...
Why separate those pieces? A conversation needs quick responses; someone watching a broadcast may prefer extra buffering if it prevents interruptions. The goal is control over that balance, as well as low latency. The moq.dev article [Replacing WebRTC](https://moq.dev/blog/replacing-webrtc/) explains this motivation from its author's experience with live broadcasting. Published in 2023, it is an architectural argument; its browser-support observations are historical.
