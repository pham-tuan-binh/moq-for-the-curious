...
This is a **publish/subscribe** model: one endpoint makes content available, and another asks to receive it. We will use a live lecture to follow that exchange throughout the book.
